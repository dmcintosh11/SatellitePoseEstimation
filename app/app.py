...
# Import the prediction function and the drawing function
from inference import predict_pose, loaded_model
from app.visualization import draw_pose_axes
...
SF3D_RUN_SCRIPT = os.path.expanduser('./app/stable_fast/run.py') 
...
#Examples are from the SPEED+ lightbox dataset
@app.route('/examples')
def list_examples():
